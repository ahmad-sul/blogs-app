    ...
    <div className="register d-flex  flex-column align-items-center  height">
      ...
      <form className="row g-3  w-50 mt-5" onSubmit={submitHandler}>
        <div className="col-12">
          <label className="form-label text-warning" htmlFor="inputUsername">
            Username:{" "}
          </label>
          <input
        ...
        <div className="col-12">
          <label htmlFor="inputEmail4" className="form-label text-warning">
            Email:{" "}
          </label>
          <input
            className="form-control text-warning"
        ...
        <div className="col-12">
          <label className="form-label text-warning" htmlFor="inputPassword4">
            Password:{" "}
          </label>
          <input
